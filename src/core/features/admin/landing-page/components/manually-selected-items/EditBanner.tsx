...
const EditBanner: React.FC<BannerProps> = ({
  data,
  ...
  return (
    <div className="item-nkw  w-full relative">
      <div className="absolute top-4 right-4 z-50 flex gap-4">
        <div
          onClick={() => {
            dispatch(setAdvertismentSection({ ...data, sectionId }));
          }}
        ...
        <div
          className="h-10 w-10 bg-slate-300 rounded-md flex items-center justify-center "
          onClick={() => {
            dispatch(
              setSelectedDeleteAd({
                ...data,
